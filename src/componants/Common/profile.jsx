                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                ...
                                <div className="d-flex justify-content-center align-items-center gap-3 mt-2 mb-2"> 
                                    <div><span className="datainfoNavigator">Education</span></div>
                                    <div><span className="datainfoNavigator">Experience</span></div>
                                    <div><span className="datainfoNavigator">Peoples</span></div>
                                </div>
